...
<body>
    <div class="confirm-mail">
        <h1>{{ $appointment->user_patient->firstname }} n'oubliez pas votre rendez-vous</h1>
        <div class="confirm-mail__date">Du {{ Carbon::parse($appointment->dateOfAppointment)->format('d/m/Y') }} à {{ Carbon::parse($appointment->timeOfAppointment)->format('H\hi') }}</div>
